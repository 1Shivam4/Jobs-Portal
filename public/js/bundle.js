(() => {
  ...
  var login = async (email, password) => {
    try {
      const res = await axios_default({
        ...
        data: { email, password }
        // Make sure you're sending 'email' instead of 'phone'
      });
  ...
  var register = async (name, phone, email, password, confirmPassword) => {
    try {
      const res = await axios_default({
        method: "POST",
  ...
  // public/js/jobPost.js
  var createJob = async (data) => {
    try {
      const res = await axios_default({
        method: "POST",
        url: "/api/v1/jobs",
  ...
  (function() {
    ...
    document.querySelectorAll(".isotope-layout").forEach(function(isotopeItem) {
      ...
      let filter2 = isotopeItem.getAttribute("data-default-filter") ?? "*";
